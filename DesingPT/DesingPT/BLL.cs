...
namespace BusinessLogicLayer
{
    public class BLL
    {
        ...
        public class Login
        {
            ...
            static public DataTable confirmar_login(string email , string palavra_pass)
            {
                DAL dal = new DAL();
                SqlParameter[] sqlParams = new SqlParameter[] {

                        new SqlParameter("@email", email),
                        new SqlParameter("@palavra_pass", palavra_pass)
                };

                return dal.executarReader("Select * from Funcionario where email = @email and palavra_pass = @palavra_pass", sqlParams);
        ...
        {
            static public DataTable get_departamento(int id)
            {
                DAL dal = new DAL();
                SqlParameter[] sqlParams = new SqlParameter[]{
                ...
                return dal.executarReader("select * from Trabalham where id_funcionarios=@id", sqlParams);
            }
        }
