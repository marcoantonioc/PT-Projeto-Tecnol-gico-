...
namespace DataAccessLayer
{
    public class DAL
    {
        ...
        public DAL()
        {
            _SqlConn = new SqlConnection(@"Data Source=(LocalDB)\MSSQLLocalDB;AttachDbFilename=C:\Users\Duarte\source\repos\DesingPT\DesingPT\Projeto_Tecnologico.mdf;Integrated Security=True;Connect Timeout=30");
        }
